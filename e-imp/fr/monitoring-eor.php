	...
	<div class="wrapper-header">
		...
		<div class="header-right">
			<form id="mntr-eor" method="post">
					<select class="w3-select w3-border" name="HampName" style="width: 175px;padding:8px 0!important;text-transform: normal!important;" required />
					...
					<button class="w3-button w3-blue right-rounded-large" type="submit" name="HampName">View</button>
			</form>
