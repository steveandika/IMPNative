<script language="php">
  ...
  $filename = 'wapp-imp_'.date('YmdHis');
...
<table style="font-size:12px;border:1px solid #ccc;border-collapse:collapse" >
  <thead>
  <tr><th colspan="13" style="border:1px solid #ccc;font-size:14px;">WAITING APPROVAL</th></tr>
  <tr>
...
<script language="php">
    if(mssql_num_rows($result) <= 0) {
	  echo '<tr><td colspan="7" style="letter-spacing:1px;color:red;font-weight:bold;text-align:left;border:1px solid #ccc;">RECORD NOT FOUND</td></tr>'; }
