...
<div class="form-header">&nbsp;&nbsp;Summary Of Hamparan/Workshop In</div>
 ...
 <div class="height-20"></div>
  ...
  <div class="w3-row-padding">
   <div class="w3-half">	
	 <form id="fquery" method="post" action="query_inworkshop" target="_blank">
        <label>From Date</label>
	    <input class="style-input style-border" type="text" name="tglIn" id="fDate1" required
