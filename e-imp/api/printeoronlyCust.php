<?php
	...
	if($msg == "connected")
	{
		if(isset($_GET['IDEstimate']) && isset($_GET['NoContainer']))
		{
  ...
  <div class="w3-container">  
      ...
      <table style="width:1100px">
        ...
        <tr> 
          ...
          <td style="text-align:right;"><?php echo number_format($DPP*$VAT,2,",",".");?></td>				
		</tr>		  
		  
        <tr> 
          <td colspan="13" style="border:0;">&nbsp;</td>		    
          <td style="text-align:right;"><h6><b>GRAND TOTAL</b></h6></td>				
          <td style="text-align:right;"><?php $grand = $DPP +($DPP*$VAT); echo number_format($grand,2,",",".");?></td>				
		</tr>		  
		</tbody>		
	  </table>
