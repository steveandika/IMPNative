...
/*		if($_GET['loc'][$i] != '' && $_GET['part'][$i] != '' && $_GET['dmg'][$i] != '' && $_GET['repair'][$i] != '' &&
	...
	if($to_do == 'SUBMIT' && $isFalse==0) 
	{
      ...
      //if(isset($_GET['kodeEstimate']) && $_GET['kodeEstimate'] != '' && substr($_GET['kodeEstimate'],0,3)=='DRF' )
...
<form id="fEOR" name="myForm" method="get" style="font-size:.850rem">
...
<!--		    <option value="IKPP_IDR">IKPP IDR</option>
			<option value="IKPP_USD">IKPP USD</option>-->
	       ...
	       <?php
		    ...
		    {		      
		      echo '<option value="'.$arrFetch[0].'">&nbsp;'.strtoupper($arrFetch[0]).'</option>';
		    }	
