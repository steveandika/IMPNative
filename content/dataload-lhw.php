...
/*	include("valid-menuAccess.php");	  
	...
	$sourcePage = "dataload-lhw-form.php"; 		
?>  

  <div class="wrapper" style="overflow-y:auto;-webkit-overflow-scrolling: touch;background-color:#ffff" >
    <div class="page-title">DataLoad - L H W</div>
